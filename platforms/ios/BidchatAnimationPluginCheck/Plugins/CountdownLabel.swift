...
@objc(CountdownLabel) public class CountdownLabel: LTMorphingLabel {
    ...
    @objc public func setBidchatAnimation() {
        animationType = CountdownEffect.Sparkle
    }
